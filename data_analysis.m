data_path = 'C:\研究生阶段资料\course\数据挖掘\2017\马的疝病分析\horse-data.txt';
%读入数据
...
fp = fopen('C:\研究生阶段资料\course\数据挖掘\2017\马的疝病分析\highest_missing_data.txt','w');
for i = 1:368;
    temp = attribute(i,:);
    temp = num2str(temp);
    fprintf(fp,'%s\r\n',temp);
...
%attribute = textread('C:\研究生阶段资料\course\数据挖掘\2017\马的疝病分析\similarity_missing_data.txt');
